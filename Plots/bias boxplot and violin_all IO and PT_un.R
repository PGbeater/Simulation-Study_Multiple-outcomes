...
ggsave(filename = "D:/Learning epi-master/Research Project/Code/Code and Result 2025/Plot box with viol_new/unmeasured/BIAS/Origin 25vsgen_S.png",plot = origin_plot_25vsgen,width = 16,height = 6,dpi = 330)
ggsave(filename = "D:/Learning epi-master/Research Project/Code/Code and Result 2025/Plot box with viol_new/unmeasured/BIAS/Origin 10vsgen_S.png",plot = origin_plot_10vsgen,width = 16,height = 6,dpi = 330)
ggsave(filename = "D:/Learning epi-master/Research Project/Code/Code and Result 2025/Plot box with viol_new/unmeasured/BIAS/Sensitivity 25vsgen_S.png",plot = combine_plot_25vsgen,width = 16,height = 18,dpi = 330)
ggsave(filename = "D:/Learning epi-master/Research Project/Code/Code and Result 2025/Plot box with viol_new/unmeasured/BIAS/Sensitivity 10vsgen_S.png",plot = combine_plot_10vsgen,width = 16,height = 18,dpi = 330)
...
ggsave(filename = "D:/Learning epi-master/Research Project/Code/Code and Result 2025/Plot box with viol_new/unmeasured/BIAS/Origin 25vsgen_SC.png",plot = origin_plot_25vsgen,width = 16,height = 6,dpi = 330)
ggsave(filename = "D:/Learning epi-master/Research Project/Code/Code and Result 2025/Plot box with viol_new/unmeasured/BIAS/Origin 10vsgen_SC.png",plot = origin_plot_10vsgen,width = 16,height = 6,dpi = 330)
ggsave(filename = "D:/Learning epi-master/Research Project/Code/Code and Result 2025/Plot box with viol_new/unmeasured/BIAS/Sensitivity 25vsgen_SC.png",plot = combine_plot_25vsgen,width = 16,height = 18,dpi = 330)
ggsave(filename = "D:/Learning epi-master/Research Project/Code/Code and Result 2025/Plot box with viol_new/unmeasured/BIAS/Sensitivity 10vsgen_SC.png",plot = combine_plot_10vsgen,width = 16,height = 18,dpi = 330)
...
ggsave(filename = "D:/Learning epi-master/Research Project/Code/Code and Result 2025/Plot box with viol_new/unmeasured/BIAS/Origin 25vsgen_C.png",plot = origin_plot_25vsgen,width = 16,height = 6,dpi = 330)
ggsave(filename = "D:/Learning epi-master/Research Project/Code/Code and Result 2025/Plot box with viol_new/unmeasured/BIAS/Origin 10vsgen_C.png",plot = origin_plot_10vsgen,width = 16,height = 6,dpi = 330)
ggsave(filename = "D:/Learning epi-master/Research Project/Code/Code and Result 2025/Plot box with viol_new/unmeasured/BIAS/Sensitivity 25vsgen_C.png",plot = combine_plot_25vsgen,width = 16,height = 18,dpi = 330)
ggsave(filename = "D:/Learning epi-master/Research Project/Code/Code and Result 2025/Plot box with viol_new/unmeasured/BIAS/Sensitivity 10vsgen_C.png",plot = combine_plot_10vsgen,width = 16,height = 18,dpi = 330)
...
ggsave(filename = "D:/Learning epi-master/Research Project/Code/Code and Result 2025/Plot box with viol_new/unmeasured/BIAS/Origin 25vsgen_US.png",plot = origin_plot_25vsgen,width = 16,height = 6,dpi = 330)
ggsave(filename = "D:/Learning epi-master/Research Project/Code/Code and Result 2025/Plot box with viol_new/unmeasured/BIAS/Origin 10vsgen_US.png",plot = origin_plot_10vsgen,width = 16,height = 6,dpi = 330)
ggsave(filename = "D:/Learning epi-master/Research Project/Code/Code and Result 2025/Plot box with viol_new/unmeasured/BIAS/Sensitivity 25vsgen_US.png",plot = combine_plot_25vsgen,width = 16,height = 18,dpi = 330)
ggsave(filename = "D:/Learning epi-master/Research Project/Code/Code and Result 2025/Plot box with viol_new/unmeasured/BIAS/Sensitivity 10vsgen_US.png",plot = combine_plot_10vsgen,width = 16,height = 18,dpi = 330)
