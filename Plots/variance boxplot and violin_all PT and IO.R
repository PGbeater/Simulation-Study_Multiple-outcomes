...
ggsave(filename = "D:/Learning epi-master/Research Project/Code/Code and Result 2025/Plot box with viol_new/without unmeasured/VAR/Origin 25vsgen_S.png",plot = origin_plot_25vsgen,width = 16,height = 6,dpi = 330)
ggsave(filename = "D:/Learning epi-master/Research Project/Code/Code and Result 2025/Plot box with viol_new/without unmeasured/VAR/Origin 10vsgen_S.png",plot = origin_plot_10vsgen,width = 16,height = 6,dpi = 330)
ggsave(filename = "D:/Learning epi-master/Research Project/Code/Code and Result 2025/Plot box with viol_new/without unmeasured/VAR/Sensitivity 25vsgen_S.png",plot = combine_plot_25vsgen,width = 16,height = 18,dpi = 330)
ggsave(filename = "D:/Learning epi-master/Research Project/Code/Code and Result 2025/Plot box with viol_new/without unmeasured/VAR/Sensitivity 10vsgen_S.png",plot = combine_plot_10vsgen,width = 16,height = 18,dpi = 330)

ggsave(filename = "D:/Learning epi-master/Research Project/Code/Code and Result 2025/Plot box with viol_new/without unmeasured/VAR/Origin_IO5IO10 25vsgen_S.png",plot = origin_plot_25vsgen_IO5IO10,width = 16,height = 6,dpi = 330)
ggsave(filename = "D:/Learning epi-master/Research Project/Code/Code and Result 2025/Plot box with viol_new/without unmeasured/VAR/Origin_IO5IO10 10vsgen_S.png",plot = origin_plot_10vsgen_IO5IO10,width = 16,height = 6,dpi = 330)
ggsave(filename = "D:/Learning epi-master/Research Project/Code/Code and Result 2025/Plot box with viol_new/without unmeasured/VAR/Sensitivity_IO5IO10 25vsgen_S.png",plot = combine_plot_25vsgen_IO5IO10,width = 16,height = 18,dpi = 330)
ggsave(filename = "D:/Learning epi-master/Research Project/Code/Code and Result 2025/Plot box with viol_new/without unmeasured/VAR/Sensitivity_IO5IO10 10vsgen_S.png",plot = combine_plot_10vsgen_IO5IO10,width = 16,height = 18,dpi = 330)
...
ggsave(filename = "D:/Learning epi-master/Research Project/Code/Code and Result 2025/Plot box with viol_new/without unmeasured/VAR/Origin 25vsgen_SC.png",plot = origin_plot_25vsgen,width = 16,height = 6,dpi = 330)
ggsave(filename = "D:/Learning epi-master/Research Project/Code/Code and Result 2025/Plot box with viol_new/without unmeasured/VAR/Origin 10vsgen_SC.png",plot = origin_plot_10vsgen,width = 16,height = 6,dpi = 330)
ggsave(filename = "D:/Learning epi-master/Research Project/Code/Code and Result 2025/Plot box with viol_new/without unmeasured/VAR/Sensitivity 25vsgen_SC.png",plot = combine_plot_25vsgen,width = 16,height = 18,dpi = 330)
ggsave(filename = "D:/Learning epi-master/Research Project/Code/Code and Result 2025/Plot box with viol_new/without unmeasured/VAR/Sensitivity 10vsgen_SC.png",plot = combine_plot_10vsgen,width = 16,height = 18,dpi = 330)

ggsave(filename = "D:/Learning epi-master/Research Project/Code/Code and Result 2025/Plot box with viol_new/without unmeasured/VAR/Origin_IO5IO10 25vsgen_SC.png",plot = origin_plot_25vsgen_IO5IO10,width = 16,height = 6,dpi = 330)
ggsave(filename = "D:/Learning epi-master/Research Project/Code/Code and Result 2025/Plot box with viol_new/without unmeasured/VAR/Origin_IO5IO10 10vsgen_SC.png",plot = origin_plot_10vsgen_IO5IO10,width = 16,height = 6,dpi = 330)
ggsave(filename = "D:/Learning epi-master/Research Project/Code/Code and Result 2025/Plot box with viol_new/without unmeasured/VAR/Sensitivity_IO5IO10 25vsgen_SC.png",plot = combine_plot_25vsgen_IO5IO10,width = 16,height = 18,dpi = 330)
ggsave(filename = "D:/Learning epi-master/Research Project/Code/Code and Result 2025/Plot box with viol_new/without unmeasured/VAR/Sensitivity_IO5IO10 10vsgen_SC.png",plot = combine_plot_10vsgen_IO5IO10,width = 16,height = 18,dpi = 330)
...
ggsave(filename = "D:/Learning epi-master/Research Project/Code/Code and Result 2025/Plot box with viol_new/without unmeasured/VAR/Origin 25vsgen_C.png",plot = origin_plot_25vsgen,width = 16,height = 6,dpi = 330)
ggsave(filename = "D:/Learning epi-master/Research Project/Code/Code and Result 2025/Plot box with viol_new/without unmeasured/VAR/Origin 10vsgen_C.png",plot = origin_plot_10vsgen,width = 16,height = 6,dpi = 330)
ggsave(filename = "D:/Learning epi-master/Research Project/Code/Code and Result 2025/Plot box with viol_new/without unmeasured/VAR/Sensitivity 25vsgen_C.png",plot = combine_plot_25vsgen,width = 16,height = 18,dpi = 330)
ggsave(filename = "D:/Learning epi-master/Research Project/Code/Code and Result 2025/Plot box with viol_new/without unmeasured/VAR/Sensitivity 10vsgen_C.png",plot = combine_plot_10vsgen,width = 16,height = 18,dpi = 330)

ggsave(filename = "D:/Learning epi-master/Research Project/Code/Code and Result 2025/Plot box with viol_new/without unmeasured/VAR/Origin_IO5IO10 25vsgen_C.png",plot = origin_plot_25vsgen_IO5IO10,width = 16,height = 6,dpi = 330)
ggsave(filename = "D:/Learning epi-master/Research Project/Code/Code and Result 2025/Plot box with viol_new/without unmeasured/VAR/Origin_IO5IO10 10vsgen_C.png",plot = origin_plot_10vsgen_IO5IO10,width = 16,height = 6,dpi = 330)
ggsave(filename = "D:/Learning epi-master/Research Project/Code/Code and Result 2025/Plot box with viol_new/without unmeasured/VAR/Sensitivity_IO5IO10 25vsgen_C.png",plot = combine_plot_25vsgen_IO5IO10,width = 16,height = 18,dpi = 330)
ggsave(filename = "D:/Learning epi-master/Research Project/Code/Code and Result 2025/Plot box with viol_new/without unmeasured/VAR/Sensitivity_IO5IO10 10vsgen_C.png",plot = combine_plot_10vsgen_IO5IO10,width = 16,height = 18,dpi = 330)
...
ggsave(filename = "D:/Learning epi-master/Research Project/Code/Code and Result 2025/Plot box with viol_new/without unmeasured/VAR/Origin 25vsgen_US.png",plot = origin_plot_25vsgen,width = 16,height = 6,dpi = 330)
ggsave(filename = "D:/Learning epi-master/Research Project/Code/Code and Result 2025/Plot box with viol_new/without unmeasured/VAR/Origin 10vsgen_US.png",plot = origin_plot_10vsgen,width = 16,height = 6,dpi = 330)
ggsave(filename = "D:/Learning epi-master/Research Project/Code/Code and Result 2025/Plot box with viol_new/without unmeasured/VAR/Sensitivity 25vsgen_US.png",plot = combine_plot_25vsgen,width = 16,height = 18,dpi = 330)
ggsave(filename = "D:/Learning epi-master/Research Project/Code/Code and Result 2025/Plot box with viol_new/without unmeasured/VAR/Sensitivity 10vsgen_US.png",plot = combine_plot_10vsgen,width = 16,height = 18,dpi = 330)

ggsave(filename = "D:/Learning epi-master/Research Project/Code/Code and Result 2025/Plot box with viol_new/without unmeasured/VAR/Origin_IO5IO10 25vsgen_US.png",plot = origin_plot_25vsgen_IO5IO10,width = 16,height = 6,dpi = 330)
ggsave(filename = "D:/Learning epi-master/Research Project/Code/Code and Result 2025/Plot box with viol_new/without unmeasured/VAR/Origin_IO5IO10 10vsgen_US.png",plot = origin_plot_10vsgen_IO5IO10,width = 16,height = 6,dpi = 330)
ggsave(filename = "D:/Learning epi-master/Research Project/Code/Code and Result 2025/Plot box with viol_new/without unmeasured/VAR/Sensitivity_IO5IO10 25vsgen_US.png",plot = combine_plot_25vsgen_IO5IO10,width = 16,height = 18,dpi = 330)
ggsave(filename = "D:/Learning epi-master/Research Project/Code/Code and Result 2025/Plot box with viol_new/without unmeasured/VAR/Sensitivity_IO5IO10 10vsgen_US.png",plot = combine_plot_10vsgen_IO5IO10,width = 16,height = 18,dpi = 330)